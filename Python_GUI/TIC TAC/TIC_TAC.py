...
winsound.PlaySound(r'C:\Users\Prince_K\Documents\Python Scripts\Python GUI\song.wav', winsound.SND_ALIAS | winsound.SND_ASYNC | winsound.SND_LOOP)
...
Button(text="PlayAgain..", font=('arial', 22, 'bold'), bg='black', fg='white',
